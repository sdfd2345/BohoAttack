...
sys.path.append("/home/yjli/AIGC/threestudio/pretrained_model/ControlNet/")
import threestudio
...
from pretrained_model.ControlNet.annotator.normalbae import NormalBaeDetector

@threestudio.register("stable-diffusion-controlnet-guidance")
class ControlNetGuidance(BaseObject):
    @dataclass
    class Config(BaseObject.Config):
        cache_dir: Optional[str] = "pretrained_model"
    ...
    def configure(self) -> None:
        ...
        if self.cfg.control_type == "normal":
            ...
            # controlnet_name_or_path = 'pretrained_model/ControlNet/models/control_v11p_sd15_normalbae.pth'
        ...
        if self.cfg.control_type == "normal":
            self.preprocessor = NormalBaeDetector(modelpath='pretrained_model/ControlNet/annotator/ckpts/scannet.pt')
...
if __name__ == "__main__":
    ...
    guidance = ControlNetGuidance(cfg.system.guidance)
    prompt_processor = threestudio.find(cfg.system.prompt_processor_type)(
        cfg.system.prompt_processor
    )
    from PIL import Image
    rgb_image = Image.open("/home/yjli/AIGC/threestudio/dataroot/freeview_0_scaled/images/000004.png")
    rgb_image = np.array(rgb_image.resize([512, 512]))
    # cv2.imwrite(".threestudio_cache/original_image.jpg", rgb_image)
    ...
    Image.fromarray(edit_image).save("images/edit_freeview_0.jpg")  
